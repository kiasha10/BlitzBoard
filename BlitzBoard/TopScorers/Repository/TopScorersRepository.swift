...
class TopScorerRepository: TopScorerRepositoryType {
    ...
    func fetchSearchResults(completion: @escaping (TopScorerResult)) {
        apiHandler.request(endpoint: "https://apiv3.apifootball.com/?action=get_events&from=2024-04-20&to=2024-04-30&league_id=152&APIkey=afd5a1ede5598029ca62b14f758edd87481d42c83fecb45afb8fa613c50efb7c", method: "GET", completion: completion)
    }
}
